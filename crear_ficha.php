           ...
           <div id="div3">
             ...
             <div class="cold-md-12">
               ...
               <label class="lgris">Numero:</label>
                <input class="btn btn-outline-warning" class="form-control" type="number" name="nombre" min="1" max="9999999999" value="" placeholder="Numero" required/>
                <br>
               ...
               <div class="form-group cold-md-3">
                       <input style="width: 20%;" class="btn btn-warning" type="submit" value="Guardar" >
