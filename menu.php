    ...
    <body >
        <div id="div1" class="container">
            ...
            <div id="div2">
                ...
                <div id="div3">
            <br> 
            <h2 class="titulo">Bienvenido Admin</h2>
                        ...
                        <input style="width: 40%;" class="btn btn-warning" type="button" onclick="location.href ='borrar_aprendiz.php'" value="Borrar aprendices">
                        <br><br>
                    ...
                    <br><br>
                    <h1 class="titulo">Brayan Sanchez Fontalvo</h1>
                </div>
            </div>
        </div>
    </body>
