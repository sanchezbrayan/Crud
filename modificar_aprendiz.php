               ...
               <form name="formulario" role="form" method="post">
                 <div class="col-md-12">
                    ...
                    <div class="form-row">
                     ...
                     <input class="form-control" type="number" name="numid" min="1" max="9999999999" autofocus value="" placeholder="IDENTIFICACIÓN" />
                     <br>
                     </div>
                       <div class="form-group cold-md-3">
                       <input style="width: 20%;" class="btn btn-warning" type="submit" value="consultar" >
              ...
              if($resultado->num_rows>0)
              {
                ...
                <form id="formulario2" role="form" method="post" action="actualizar_aprendiz.php">
                    <div class="col-md-12">
                       ...
                       <input class="form-control" type="text" name="id_apre" disabled="disabled" value="<?php echo $fila->id_apre?>"/>
                       ...
                       <input class="form-control" type="number" name="telefono" min="1" max="9999999999" value="<?php echo $fila->apre_telefono ?>" required/>
                       <br>
