               ...
               <form name="formulario" role="form" method="post">
                 <div class="col-md-12">
                    ...
                    <div class="form-row">
                     ...
                     <input class="form-control" type="number" name="nombre" min="1" max="9999999999" value="" placeholder="Numero" required/>
                     <br>
                     </div>
              ...
              if($resultado->num_rows>0)
              {
                ...
                <form id="formulario2" role="form" method="post" action="actualizar_ficha.php">
                    <div class="col-md-12">
                       ...
                       <input class="form-control" type="number" name="ide1" min="1" max="9999999999" value="<?php echo $fila->id_ficha?>" required/>

                       <label class="lgris">Programa:</label>
                       <input class="form-control" type="number" name="fichapro" min="1" max="999999999999" value="<?php echo $fila->fichapro?>" required/>
                ...
                <?php
                  ...
                  echo 'window.location="modificar_ficha.php";';
                  echo '</script>';
              }
            $miconexion->close();
          }?>
